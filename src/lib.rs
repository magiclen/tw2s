        ...
        Some(tw_path) => {
            ...
            let s_path = match config.s_path {
                ...
                None => {
                    ...
                    let file_stem = tw_path.file_stem().unwrap().to_str().unwrap();
                    let extension = tw_path.extension().unwrap().to_str().unwrap();

                    let file_stem = if file_stem.ends_with(".cht") {
                    ...
                    let file_name = format!("{}.chs.{}", file_stem, extension);
